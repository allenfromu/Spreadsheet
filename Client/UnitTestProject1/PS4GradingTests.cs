//Edited by Jackson Stafford for CS 3500, October 2014
//Changed set cell function calls for update between PS4 and PS5
using SS;
...
namespace GradingTests
{
    ...
    public class SpreadsheetTest
    {
        ...
        public void Test43()
        {
            ...
            HashSet<string> returned2 = s.SetContentsOfCell("A1499", "0") as HashSet<string>;
            Assert.IsTrue(returned2.SetEquals(lastCells));
